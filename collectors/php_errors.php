...
class QM_Collector_PHP_Errors extends QM_Collector
{
  ...
  public function set_up()
  {
    ...
    $this->previous_error_handler = set_error_handler([$this, 'error_handler'], (E_ALL ^ QM_ERROR_FATALS));
    ...
    $this->previous_exception_handler = set_exception_handler([$this, 'exception_handler']);
  ...
  public function process()
  {
    ...
    if (! empty($this->data) && ! empty($this->data['errors'])) {
       ...
       */
      $levels = apply_filters('qm/collect/php_error_levels', []);
      ...
      array_map([$this, 'filter_reportable_errors'], $levels, array_keys($levels));
